...
#for A grade
    '75': {'instruction': 'ADC', 'AMOD': 'zpg,X'},
    '7D': {'instruction': 'ADC', 'AMOD': 'abs,X'},
    '79': {'instruction': 'ADC', 'AMOD': 'abs,Y'},
    #'61': {'instruction': 'ADC', 'AMOD': 'x,ind'},
    #'71': {'instruction': 'ADC', 'AMOD': 'abs'},
    '35': {'instruction': 'AND', 'AMOD': 'zpg,X'},
    '3D': {'instruction': 'AND', 'AMOD': 'abs,X'},
    '39': {'instruction': 'AND', 'AMOD': 'abs,Y'},
    #'21': {'instruction': 'AND', 'AMOD': 'abs'},
    #'31': {'instruction': 'AND', 'AMOD': 'abs'},
    '16': {'instruction': 'ASL', 'AMOD': 'zpg,X'},
    '1E': {'instruction': 'ASL', 'AMOD': 'abs,X'},
    'D5': {'instruction': 'CMP', 'AMOD': 'zpg,X'},
    'DD': {'instruction': 'CMP', 'AMOD': 'abs,X'},
    'D9': {'instruction': 'CMP', 'AMOD': 'abs,Y'},
    #'C1': {'instruction': 'CMP', 'AMOD': 'abs'},
    #'D1': {'instruction': 'CMP', 'AMOD': 'abs'},
    'D6': {'instruction': 'DEC', 'AMOD': 'zpg,X'},
    'DE': {'instruction': 'DEC', 'AMOD': 'abs,X'},
    '55': {'instruction': 'EOR', 'AMOD': 'zpg,X'},
    '5D': {'instruction': 'EOR', 'AMOD': 'abs,X'},
    '59': {'instruction': 'EOR', 'AMOD': 'abs,Y'},
    #'41': {'instruction': 'EOR', 'AMOD': 'abs'},
    #'51': {'instruction': 'EOR', 'AMOD': 'abs'},
    'F6': {'instruction': 'INC', 'AMOD': 'zpg,X'},
    'FE': {'instruction': 'INC', 'AMOD': 'abs,X'},
    'B5': {'instruction': 'LDA', 'AMOD': 'zpg,X'},
    'BD': {'instruction': 'LDA', 'AMOD': 'abs,X'},
    'B9': {'instruction': 'LDA', 'AMOD': 'abs,Y'},
    #'A1': {'instruction': 'LDA', 'AMOD': 'abs'},
    #'B1': {'instruction': 'LDA', 'AMOD': 'abs'},
    'B6': {'instruction': 'LDX', 'AMOD': 'zpg,Y'},
    'BE': {'instruction': 'LDX', 'AMOD': 'abs,Y'},
    'B4': {'instruction': 'LDY', 'AMOD': 'zpg,X'},
    'BC': {'instruction': 'LDY', 'AMOD': 'abs,X'},
    '56': {'instruction': 'LSR', 'AMOD': 'zpg,X'},
    '5E': {'instruction': 'LSR', 'AMOD': 'abs,X'},
    '15': {'instruction': 'ORA', 'AMOD': 'zpg,X'},
    '1D': {'instruction': 'ORA', 'AMOD': 'abs,X'},
    '19': {'instruction': 'ORA', 'AMOD': 'abs,Y'},
    #'01': {'instruction': 'ORA', 'AMOD': 'abs'},
    #'11': {'instruction': 'ORA', 'AMOD': 'abs'},
    '36': {'instruction': 'ROL', 'AMOD': 'zpg,X'},
    '3E': {'instruction': 'ROL', 'AMOD': 'abs,X'},
    '76': {'instruction': 'ROR', 'AMOD': 'zpg,X'},
    '7E': {'instruction': 'ROR', 'AMOD': 'abs,X'},
    'F5': {'instruction': 'SBC', 'AMOD': 'zpg,X'},
    'FD': {'instruction': 'SBC', 'AMOD': 'abs,X'},
    'F9': {'instruction': 'SBC', 'AMOD': 'abs,Y'},
    #'E1': {'instruction': 'SBC', 'AMOD': 'abs'},
    #'F1': {'instruction': 'SBC', 'AMOD': 'abs'},
    '95': {'instruction': 'STA', 'AMOD': 'zpg,X'},
    '9D': {'instruction': 'STA', 'AMOD': 'abs,X'},
    '99': {'instruction': 'STA', 'AMOD': 'abs,Y'},
    #'81': {'instruction': 'STA', 'AMOD': 'abs'},
    #'91': {'instruction': 'STA', 'AMOD': 'abs'},
    '96': {'instruction': 'STX', 'AMOD': 'zpg,Y'},
    '94': {'instruction': 'STY', 'AMOD': 'zpg,X'}}
